...
@interface DFQRCodeScanManager () <AVCaptureMetadataOutputObjectsDelegate>
...
@implementation DFQRCodeScanManager

static DFQRCodeScanManager *_instance;
...
- (void)captureOutput:(AVCaptureOutput *)captureOutput didOutputMetadataObjects:(NSArray *)metadataObjects fromConnection:(AVCaptureConnection *)connection {
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(DFQRCodeScanManager:didOutputMetadataObjects:)]) {
        [self.delegate DFQRCodeScanManager:self didOutputMetadataObjects:metadataObjects];
    }
}
